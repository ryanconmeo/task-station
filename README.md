...
<p>
  <img alt="version" src="https://img.shields.io/badge/version-2.18.0-blue">
...
| `/task-station:brief` | Render a deterministic house-style HTML one-pager for a task — decision, vocabulary, before→after, diagrams, one rule, plan, a hyperlinked ADO tree, and provenance — from a model-supplied brief-spec (JSON). Written under the artifacts dir; the path is recorded on the task. Also `/todo brief`. |
