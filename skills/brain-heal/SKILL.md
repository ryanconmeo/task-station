...
3b. **Naming conformance** (the half `brain.heal_lint` cannot see): walk `notes/` and
   the hub notes and check the shape itself — every knowledge node's slug should be
